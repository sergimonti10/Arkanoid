...
public class YellowBlock extends PrincipalObject {
	 ...
	 */
	public YellowBlock(int x, int y, String nombre, int ancho, int alto) {
		super(x, y, ancho, alto);
		this.nombre = nombre;
		this.setSpriteActual(ResourcesCache.getInstance().getImagen(ResourcesCache.YELLOW_BLOCK_IMAGE));
	}
